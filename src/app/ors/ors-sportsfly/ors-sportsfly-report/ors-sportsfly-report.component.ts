...
import { ApiOptionsInterface, ApiObservationsSportsflyItem } from 'app/api/api.interface';
...
@Component({
  ...
  templateUrl: './ors-sportsfly-report.component.html',
  styleUrls: ['./ors-sportsfly-report.component.css'],
})
export class NlfOrsSportsflyReportComponent implements OnInit {

  @Input() inputId?: number; // Allows to use seperately

  id: number;
  version: number;
  observation: ApiObservationsSportsflyItem;
  dataDiff: any;
  dataReady = false;
  error;
  spinner = true;
