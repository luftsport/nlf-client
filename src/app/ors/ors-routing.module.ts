...
const nlfOrsRoutes: Routes = [
  ...
  { path: 'ors/fallskjerm/edit/:id', component: NlfOrsFallskjermEditorComponent, canActivate: [NlfAuthGuard], data: { title: 'OBSREG - Fallskjerm editor' } },
  ...
  { path: 'ors/sportsfly/edit/:id', component: NlfOrsSportsflyEditorComponent, canActivate: [NlfAuthGuard], data: { title: 'OBSREG - Sportsfly editor' } },
  ...
  { path: 'ors/seilfly/edit/:id', component: NlfOrsSeilflyEditorComponent, canActivate: [NlfAuthGuard], data: { title: 'OBSREG - Seilfly editor' } },
