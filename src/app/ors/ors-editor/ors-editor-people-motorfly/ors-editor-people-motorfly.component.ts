...
@Component({
  selector: 'nlf-ors-editor-people-motorfly',
  templateUrl: './ors-editor-people-motorfly.component.html',
  styleUrls: ['./ors-editor-people-motorfly.component.css']
})
export class NlfOrsEditorPeopleMotorflyComponent implements OnInit {
  /**
