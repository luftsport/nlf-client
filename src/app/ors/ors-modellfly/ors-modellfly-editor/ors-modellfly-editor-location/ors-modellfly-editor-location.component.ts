...
import { isEqual, has as _has } from 'lodash';

@Component({
  selector: 'nlf-ors-modellfly-editor-location',
  templateUrl: './ors-modellfly-editor-location.component.html',
  styleUrls: ['./ors-modellfly-editor-location.component.css']
})
export class NlfOrsModellflyEditorLocationComponent implements OnInit, AfterViewInit {
      ...
      this.subject.observableObservation.subscribe(
        observation => {
          ...
          if (!this.observation || !isEqual(this.observation?.location, observation?.location)) {
            ...
            if (_has(observation, 'discipline') && !!observation.discipline) {
