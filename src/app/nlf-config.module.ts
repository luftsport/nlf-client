...
export const NLF_DI_CONFIG: NlfConfig = {
  ...
  motorfly: {
    ...
    observation: {
      ...
      stateArr: ['withdrawn', 'draft', 'pending_review_ors', 'pending_review_dto', 'pending_review_skole', 'pending_review_teknisk', 'closed'],
      stateRoles: {
        draft: 'Observatør',
        pending_review_ors: 'ORS koordinator',
      ...
      state: {
        ...
        pending_review_ors: { badge: 'info', icon: 'clock-o', label: 'ORS', descr: 'Avventer ORS ansvarlig' },
